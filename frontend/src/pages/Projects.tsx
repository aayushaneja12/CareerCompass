...
import { LogOut, Compass, Code2, Star, Bookmark, BookmarkCheck, Layers, GitBranch, Menu } from "lucide-react";
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate">Build portfolio projects for your career</p>
              </div>
            </div>
            <Button
              variant="ghost"
